...
Данный раздел реализует метод, а в последующих разделах будут даны методы стастических проверок через **Колмогорова-Смирнова (KS-test)** и **кси-квадрат (chi-square)** для проверки корректности метода.
...
* Отдельные слоты для команды. Добавлю реализацию чуть позже, но обычно важно когда тест проводится через Амплитуду
